...
export const DogImageList2: imageType[] = [
    {Image: img, Description:"Adult Chicken, Rice, & Vegetables"},
    {Image: img, Description:"Adult Chicken, Rice, & Vegetables"},
    {Image: img, Description:"Adult Chicken, Rice, & Vegetables"},
    {Image: img, Description:"Adult Chicken, Rice, & Vegetables"},
...
export const images= (item: imageType[], j : number, g :number, name : String ) => {

        for (let i = j; i < item.length; i++) {
            if (j === 0) {
                return (
                    <div className="media-group" id={`${name}-${g}`}>
                        ...
                        <a className="next" href={`#${name}-2` }aria-label="next">
                            <svg>
                                <use href="#next"></use>
                            </svg>
                        </a>
                ...
                return (
                    <div className="media-group" id={`${name}-${g}`}>
                        <a className="previous" href={`#${name}-${g-1}`}>
                            <svg>
                        ...
                        <a className="next" href={`#${name}-${g+1}`} aria-label="next">
                            <svg>
                                <use href="#next"></use>
                            </svg>
                        </a>
...
export const netflixStyle = (item: imageType[], j : number, g :number, name : String , sec: number) => {

    for (let i = j; i < item.length; i++) {
            if (j === 0) {
                return(
                <section id={`section${sec}`}>
                <a href={`#section${sec - 1} `}className="arrow__btn left-arrow">‹</a>
                <div className="item">
                  <a href="#">
            <Image
            src={item[0].Image} alt=""/>
            ...
            <p className="duration">Duration: 10 min</p>
                ...
                <a href={`#section${sec+1}`} className="arrow__btn right-arrow">›</a>
              </section>)
            } else {
                <section id={`section${sec}`}>
                <a href={`#section${sec-1}`} className="arrow__btn left-arrow">‹</a>
